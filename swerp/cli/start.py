...
from swerp.modules.module import get_module_root, MANIFEST_NAMES
from swerp.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the swerp server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            swerp.tools.config['init']['base'] = True
