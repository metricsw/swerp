...
RPC_VERSION_1 = {
        'server_version': swerp.release.version,
        'server_version_info': swerp.release.version_info,
        'server_serie': swerp.release.serie,
        'protocol_version': 1,
}
...
def exp_about(extended=False):
    ...
    if extended:
        return info, swerp.release.version
    return info

def exp_set_loglevel(loglevel, logger=None):
    # TODO Previously, the level was set on the now deprecated
    # `swerp.netsvc.Logger` class.
    return True
