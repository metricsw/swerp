...
from swerp.tests.common import users
from swerp.addons.test_mass_mailing.tests import common
from swerp.addons.test_mass_mailing.models.mass_mail_test import MassMailTestBlacklist
