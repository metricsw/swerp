...
from swerp.addons.test_mass_mailing.tests.common import MassMailingCase
from swerp.addons.base.models.ir_config_parameter import IrConfigParameter
from swerp.tests.common import TransactionCase, users
