...
from swerp.exceptions import RedirectWarning, UserError, ValidationError
from swerp.tools.misc import formatLang, format_date
from swerp.tools import float_is_zero, float_compare
...
class AccountMoveLine(models.Model):
    ...
    def _apply_taxes(self, vals, amount):
        tax_lines_vals = []
        # Get ids from triplets : https://www.swerp.it/documentation/10.0/reference/orm.html#swerp.models.Model.write
