...
from swerp.tools import email_re, email_split, email_escape_char, float_is_zero, float_compare, \
    pycompat, date_utils
from swerp.tools.misc import formatLang

from swerp.exceptions import AccessError, UserError, RedirectWarning, ValidationError, Warning
...
class AccountInvoice(models.Model):
    ...
    def message_new(self, msg_dict, custom_values=None):
        ...
        # 2) otherwise, if the email sender is from swerp internal users then it is likely that the vendor sent the bill
