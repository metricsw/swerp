...
The Swerp <a href="https://www.swerp.it/page/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. Swerp's user interface is designed with productivity in mind.
...
accounting; Swerp has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

Swerp supports multiple currencies, multiple users with different access rights,
