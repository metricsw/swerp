...
from swerp import api, fields, models, _, SUPERUSER_ID
from swerp.osv import expression
from swerp.tools import DEFAULT_SERVER_DATETIME_FORMAT
from swerp.tools.float_utils import float_compare, float_is_zero, float_round
from swerp.exceptions import UserError
from swerp.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        'Show Reserved', default=True, help="If this checkbox is ticked, Swerp will show which products are reserved (lot/serial number, source location, source package).")
