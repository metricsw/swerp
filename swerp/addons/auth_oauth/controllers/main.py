...
from swerp import api, http, SUPERUSER_ID, _
from swerp.exceptions import AccessDenied
from swerp.http import request
from swerp import registry as registry_get

from swerp.addons.auth_signup.controllers.main import AuthSignupHome as Home
from swerp.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via Swerp Account provider"""
