...
mkdir -v /var/log/swerp
chown pi:pi /var/log/swerp
chown pi:pi -R /home/pi/swerp/
...
echo "* * * * * rm /var/run/swerp/sessions/*" | crontab -
...
echo "addons/hw_drivers/drivers/" > /home/pi/swerp/.git/info/exclude
