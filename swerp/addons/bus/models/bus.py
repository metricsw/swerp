...
import swerp
from swerp import api, fields, models, SUPERUSER_ID
from swerp.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
from swerp.tools import date_utils
...
class ImBus(models.Model):
    ...
    def sendmany(self, notifications):
        ...
        if channels:
            ...
            def notify():
                with swerp.sql_db.db_connect('postgres').cursor() as cr:
...
dispatch = None
if not swerp.multi_process or swerp.evented:
