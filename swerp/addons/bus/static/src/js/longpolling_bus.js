swerp.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether swerp is focused or not
     *
     * @returns {boolean}
     */
    isSwerpFocused: function () {
        return this._isSwerpFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isSwerpFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isSwerpFocused);
        }
    },
    /**
