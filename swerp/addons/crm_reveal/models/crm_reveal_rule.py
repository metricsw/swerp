...
from swerp.addons.iap import jsonrpc
from swerp.addons.crm.models import crm_stage
from swerp.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.swerp.it'
...
class CRMRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.reveal.industry', string='Industry Tags', help='Leave empty to always match. Swerp will not create lead if no match')
    ...
    # Methods responsible for format response data in to valid swerp lead data
