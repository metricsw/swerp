(function (exports) {
    ...
    function createWebClientHooks() {
        var AbstractController = swerp.__DEBUG__.services['web.AbstractController'];
        var Discuss = swerp.__DEBUG__.services['mail.Discuss'];
        var WebClient = swerp.__DEBUG__.services["web.WebClient"];
