swerp.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that swerp actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute swerp actions, given as an ID in
     ...
     * @private
     * @param {swerpEvent} ev
     * @param {swerpEvent} ev.data.controllerID
     */
