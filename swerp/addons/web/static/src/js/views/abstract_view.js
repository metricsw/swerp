swerp.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. swerp JS views are the
 ...
 * the word 'view' has historical significance in swerp code, so we replaced the
...
swerp.define('web.viewUtils', function () {
"use strict";
