swerp.define('web.mixins', function (require) {
"use strict";
...
function swerpEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
swerpEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

swerpEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new swerpEvent(this, name, info);
