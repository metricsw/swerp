swerp.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in swerp.
 *
 * The basic concurrency primitives in swerp JS are the callback, and the
...
return {
    ...
    /**
     * A (swerp) mutex is a primitive for serializing computations.  This is
