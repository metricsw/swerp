...
import swerp
from swerp.tools.misc import DotDict
...
def MockRequest(
    ...
    with contextlib.ExitStack() as s:
        swerp.http._request_stack.push(request)
        s.callback(swerp.http._request_stack.pop)
        s.enter_context(patch('swerp.http.root.get_db_router', router))
