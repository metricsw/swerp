swerp.define('website.seo', function (require) {
'use strict';
...
var MetaImageSelector = Widget.extend({
    ...
    init: function (parent, data) {
        ...
        data.pageImages.unshift(_.str.sprintf('/web/image/res.company/%s/logo', swerp.session_info.website_company_id));
        data.pageImages.unshift(_.str.sprintf('/web/image/website/%s/social_default_image', swerp.session_info.website_id));
