...
import swerp
from swerp import api, models, registry
...
from swerp.osv.expression import FALSE_DOMAIN, OR

from swerp.addons.base.models.qweb import QWebException
from swerp.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
from swerp.addons.portal.controllers.portal import _build_url_w_params
...
def get_request_website():
    ...
    ```
    from swerp.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _handle_exception(cls, exception):
        ...
        if not is_website_request:
            ...
            if isinstance(exception, swerp.exceptions.AccessError):
                code = 403
            ...
            if isinstance(exception, QWebException):
                ...
                if type(exception.error) == swerp.exceptions.AccessError:
                    code = 403
