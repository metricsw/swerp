...
from swerp.tests.common import TransactionCase, users, warmup
...
class TestAdvMailPerformance(TransactionCase):
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('swerp.models.unlink')
    def test_adv_activity_full(self):
        ...
        with self.assertQueryCount(__system__=27, emp=46):  # com runbot: 26 - 46 // test_mail only: 27 - 46
    ...
    def test_adv_activity_mixin(self):
        ...
        with self.assertQueryCount(__system__=29, emp=48):  # com runbot: 28 - 86 // test_mail only: 29 - 48
            record.action_close('Dupe feedback')

        self.assertEqual(record.activity_ids, self.env['mail.activity'])

    @mute_logger('swerp.addons.mail.models.mail_mail', 'swerp.models.unlink')
    @users('__system__', 'emp')
    @warmup
...
class TestHeavyMailPerformance(TransactionCase):
    ...
    @mute_logger('swerp.tests', 'swerp.addons.mail.models.mail_mail', 'swerp.models.unlink')
    @users('__system__', 'emp')
    @warmup
