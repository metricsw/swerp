...
from swerp import exceptions, tests
from swerp.addons.test_mail.tests.common import BaseFunctionalTest
from swerp.addons.test_mail.tests.common import mail_new_test_user
from swerp.addons.test_mail.models.test_mail_models import MailTestActivity
