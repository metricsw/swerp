...
from swerp.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
...
class TestMessagePost(BaseFunctionalTest, MockEmails, TestRecipients):
    ...
    @mute_logger('swerp.addons.mail.models.mail_mail', 'swerp.addons.mail.models.mail_thread')
