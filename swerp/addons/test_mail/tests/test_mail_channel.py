...
from swerp.exceptions import AccessError, except_orm, ValidationError, UserError
...
class TestChannelAccessRights(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('swerp.addons.base.models.ir_model', 'swerp.models')
    ...
    @mute_logger('swerp.addons.base.models.ir_model', 'swerp.models', 'swerp.models.unlink')
...
class TestChannelModeration(common.Moderation):
    ...
    @mute_logger('swerp.addons.mail.models.mail_channel', 'swerp.models.unlink')
