...
from swerp.addons.test_mail.data.test_mail_data import \
    ...
    MAIL_XHTML
from swerp.addons.test_mail.tests.common import BaseFunctionalTest, MockEmails
from swerp.addons.test_mail.tests.common import mail_new_test_user
from swerp.tools import mute_logger, formataddr


class TestEmailParsing(BaseFunctionalTest, MockEmails):

    @mute_logger('swerp.addons.mail.models.mail_thread')
...
class TestMailgateway(BaseFunctionalTest, MockEmails):
    ...
    @mute_logger('swerp.addons.mail.models.mail_thread', 'swerp.models')
    ...
    @mute_logger('swerp.addons.mail.models.mail_thread', 'swerp.models.unlink', 'swerp.addons.mail.models.mail_mail')
    ...
    @mute_logger('swerp.addons.mail.models.mail_thread', 'swerp.addons.mail.models.mail_mail', 'swerp.models.unlink')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by swerp should update thread accordingly """
    ...
    @mute_logger('swerp.addons.mail.models.mail_thread', 'swerp.models', 'swerp.addons.mail.models.mail_mail')
