...
from swerp.addons.test_mail.models.test_mail_models import MailTestSimple
from swerp.exceptions import AccessError, except_orm
...
class TestMessageAccess(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('swerp.addons.base.models.ir_model')
