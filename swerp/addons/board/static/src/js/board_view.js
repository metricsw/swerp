swerp.define('board.BoardView', function (require) {
"use strict";
    ...
    _createController: function (params) {
        ...
        return this._rpc({
            ...
            .then(function (action) {
                ...
                // override the https://github.com/swerp/swerp/pull/28408language to take the current one
...
swerp.define('board.viewRegistry', function (require) {
"use strict";
