...
from swerp.addons.payment_ogone.controllers.main import OgoneController
from swerp.addons.payment_ogone.data import ogone
from swerp.http import request
from swerp.tools import DEFAULT_SERVER_DATE_FORMAT, ustr
from swerp.tools.float_utils import float_compare, float_repr, float_round
...
class PaymentAcquirerOgone(models.Model):
    ...
    def _ogone_generate_shasign(self, inout, values):
        ...
        :param string inout: 'in' (swerp contacting ogone) or 'out' (ogone
                             contacting swerp). In this last case only some
