...
Also, adds methods to convert values back to Swerp models.
"""
...
from swerp.tools import ustr, posix_to_ldml, pycompat
from swerp.tools import html_escape as escape
from swerp.tools.misc import babel_locale_parse
from swerp.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = swerp.modules.get_module_resource(
