swerp.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.swerp[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.swerp[callback + '_editor']) {
                window.top.swerp[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.swerp[callback + '_downup']) {
                    window.top.swerp[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
swerp.define('root.widget', function (require) {
'use strict';
...
swerp.define('web_editor.IframeRoot', function (require) {
'use strict';
