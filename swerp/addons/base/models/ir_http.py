...
import swerp
from swerp import api, http, models, tools, SUPERUSER_ID
from swerp.exceptions import AccessDenied, AccessError
from swerp.http import request, STATIC_CACHE, content_disposition
from swerp.tools import pycompat, consteq
from swerp.tools.mimetypes import guess_mimetype
from ast import literal_eval
from swerp.modules.module import get_resource_path, get_module_path
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls):
        if not hasattr(cls, '_routing_map'):
            ...
            if tools.config['test_enable'] and swerp.modules.module.current_test:
                installed.add(swerp.modules.module.current_test)
            mods = [''] + swerp.conf.server_wide_modules + sorted(installed)
