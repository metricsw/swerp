...
from swerp import fields, tools, SUPERUSER_ID
from swerp.tools.pycompat import string_types, to_text
from swerp.http import request
from swerp.modules.module import get_resource_path
from .qweb import escape
import psycopg2
from swerp.tools import func, misc
        ...
        return """
            (function (message) {
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    if (typeof swerp === "undefined") return;

                    swerp.define("AssetsBundle.ErrorMessage", function (require) {
                        "use strict";
    ...
    def compile_css(self, compiler, source):
        ...
        def sanitize(matchobj):
            ...
            if '.' not in ref and line not in imports and not ref.startswith(('.', '/', '~')):
                imports.append(line)
                return line
            msg = "Local import '%s' is forbidden for security reasons. Please remove all @import {your_file} imports in your custom files. In swerp you have to import all files in the assets, and not through the @import statement." % ref
            _logger.warning(msg)
