...
from swerp import api, models, tools
from swerp.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from swerp.http import request
from swerp.modules.module import get_resource_path

from swerp.addons.base.models.qweb import QWeb, Contextifier
from swerp.addons.base.models.assetsbundle import AssetsBundle
