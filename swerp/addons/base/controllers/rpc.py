...
from swerp.http import Controller, dispatch_rpc, request, route
from swerp.service import wsgi_server
from swerp.fields import Date, Datetime
from swerp.tools import lazy


class swerpMarshaller(xmlrpc.client.Marshaller):
...
xmlrpc.client.Marshaller = swerpMarshaller
