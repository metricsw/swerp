...
from swerp.tests.common import BaseCase
from swerp.tests.common import SavepointCase
from swerp.tools import html_sanitize, append_content_to_html, plaintext2html, email_split, misc, decode_smtp_header
...
class EmailConfigCase(SavepointCase):
    @patch.dict("swerp.tools.config.options", {"email_from": "settings@example.com"})
