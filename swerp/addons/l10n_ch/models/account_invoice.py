...
from swerp.exceptions import ValidationError, UserError
from swerp.tools.float_utils import float_split_str
from swerp.tools.misc import mod10r
...
class AccountInvoice(models.Model):
    ...
    def can_generate_qr_bill(self):
        ...
        # First part of this condition is due to fix commit https://github.com/swerp/swerp/commit/719f087b1b5be5f1f276a0f87670830d073f6ef4
