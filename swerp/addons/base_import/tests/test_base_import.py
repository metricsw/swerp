...
from swerp.tests.common import TransactionCase, can_import
from swerp.modules.module import get_module_resource
from swerp.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('swerp.addons.base_import.models.base_import')
