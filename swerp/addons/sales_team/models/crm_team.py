...
from swerp.exceptions import AccessError, UserError
from swerp.release import version
from swerp.tools import DEFAULT_SERVER_DATE_FORMAT as DF
...
class CrmTeam(models.Model):
    ...
    reply_to = fields.Char(string='Reply-To',
                           help="The email address put in the 'Reply-To' of all emails sent by Swerp about cases in this Sales Team")
