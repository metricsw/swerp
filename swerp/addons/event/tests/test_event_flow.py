...
from swerp.addons.event.tests.common import TestEventCommon
from swerp.exceptions import ValidationError, UserError, AccessError
...
class TestEventFlow(TestEventCommon):
    ...
    def test_event_date_range(self):
        self.patcher = patch('swerp.addons.event.models.event.fields.Datetime', wraps=Datetime)
