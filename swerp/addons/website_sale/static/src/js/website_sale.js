swerp.define('website_sale.cart', function (require) {
'use strict';
...
swerp.define('website_sale.website_sale_category', function (require) {
'use strict';
...
swerp.define('website_sale.website_sale', function (require) {
'use strict';
...
var sAnimations = require('website.content.snippets.animation');
require("website.content.zoomswerp");
...
sAnimations.registry.WebsiteSale = sAnimations.Class.extend(ProductConfiguratorMixin, {
            ...
            _.each($('.ecom-zoomable img[data-zoom]'), function (el) {
                onImageLoaded(el, function () {
                    ...
                    if (!_.str.endsWith(el.src, el.dataset.zoomImage) || // if zoom-img != img
                        ...
                        $img.zoomSwerp({event: autoZoom ? 'mouseenter' : 'click', attach: attach});
    ...
    _updateProductImage: function ($productContainer, productId, productTemplateId, new_carousel, isCombinationPossible) {
        ...
        if (new_carousel) {
            ...
            if ($img.data('zoomSwerp') !== undefined) {
                $img.data('zoomSwerp').isReady = false;
            }
        }
