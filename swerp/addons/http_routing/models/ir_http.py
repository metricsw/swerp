...
from swerp.addons.base.models.ir_http import RequestUID, ModelConverter
from swerp.http import request
from swerp.tools import config, ustr, pycompat
...
class IrHttp(models.AbstractModel):
    ...
    def _geoip_resolve(cls):
        if 'geoip' not in request.session:
            record = {}
            if swerp._geoip_resolver and request.httprequest.remote_addr:
                record = swerp._geoip_resolver.resolve(request.httprequest.remote_addr) or {}
    ...
    def _postprocess_args(cls, arguments, rule):
        ...
        except swerp.exceptions.MissingError:
