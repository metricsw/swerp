...
class TestWebsiteResetViews(swerp.tests.HttpCase):
    def do_test(self, name):
        self.browser_js(
            "/",
            "swerp.__DEBUG__.services['web_tour.tour'].run('%s')" % name,
            "swerp.__DEBUG__.services['web_tour.tour'].tours.%s.ready" % name,
            login="admin"
        )
    ...
    @mute_logger('swerp.addons.website.models.ir_http')
    ...
    # @mute_logger('swerp.addons.website.models.ir_http', 'swerp.addons.website.models.ir_ui_view')
