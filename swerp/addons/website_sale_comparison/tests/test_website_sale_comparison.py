...
class TestWebsiteSaleComparison(swerp.tests.TransactionCase):
...
class TestUi(swerp.tests.HttpCase):
    ...
    def test_01_admin_tour_product_comparison(self):
        self.phantom_js("/", "swerp.__DEBUG__.services['web_tour.tour'].run('product_comparison')", "swerp.__DEBUG__.services['web_tour.tour'].tours.product_comparison.ready", login='admin')
