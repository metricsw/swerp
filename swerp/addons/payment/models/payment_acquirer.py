...
from swerp import api, exceptions, fields, models, _
from swerp.tools import consteq, float_round, image_resize_images, image_resize_image, ustr
from swerp.addons.base.models import ir_module
from swerp.exceptions import ValidationError
from swerp import api, SUPERUSER_ID
from swerp.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
from swerp.tools.misc import formatLang
...
class PaymentAcquirer(models.Model):
    ...
    capture_manually = fields.Boolean(string="Capture Amount Manually",
        help="Capture the amount from Swerp, when the delivery is completed.")
