swerp.define('iap.CrashManager', function (require) {
"use strict";
...
CrashManager.include({
    ...
    _getButtonMessage: function (isTrial){
        var isEnterprise = _.last(swerp.session_info.server_version_info) === 'e';
        return isTrial && isEnterprise ? _t('Start a Trial at Swerp') : _t('Buy credits at Swerp');
    },
    /**
     * @override
     */
    rpc_error: function (error) {
        var self = this;
        if (error.data.name === "swerp.addons.iap.models.iap.InsufficientCreditError") {
            ...
            ajax.jsonRpc('/web/dataset/call_kw', 'call', {
                ...
                var content = $(QWeb.render('iap.redirect_to_swerp_credit', {
                        data: error_data,
                    }));
                if (error_data.body) {
