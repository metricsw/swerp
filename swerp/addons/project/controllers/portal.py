...
from swerp.addons.portal.controllers.portal import CustomerPortal, pager as portal_pager
from swerp.tools import groupby as groupbyelem

from swerp.osv.expression import OR
