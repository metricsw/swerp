swerp.define('partner_autocomplete.tests', function (require) {
    "use strict";
    ...
    QUnit.module('partner_autocomplete', {
        before: function () {
            var suggestions = [
                {name: "Swerp", website: "swerp.it", domain: "swerp.it", logo: "swerp.it/logo.png", vat: "BE0477472701"}
            ];
            ...
            testUtils.patch(AutocompleteCore, {
                _getBase64Image: function (url) {
                    return $.when(url === "swerp.it/logo.png" ? "swerpbase64" : "");
                },
                isOnline: function () {
                    return true;
                },
                ...
                _getSwerpSuggestions(value, isVAT) {
                ...
                _getClearbitSuggestions(value) {
                    return this._getSwerpSuggestions(value);
                },
            });
        ...
        createView({
            ...
            mockRPC: function (route, args) {
                ...
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "swerp.it/logo.png"
                    || route === "data:image/png;base64,swerpbase64") { // land here as it is not valid base64 content
                    return $.when();
                }
            ...
            assert.strictEqual($input.val(), "Swerp", "Input value should have been updated to \"Swerp\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "swerp.it", "website value should have been updated to \"swerp.it\"");
            ...
            $input.val("swerp").trigger("input");
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing swerp letters again");
