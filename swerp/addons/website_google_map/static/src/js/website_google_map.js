function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('swerp-google-map'), {
        zoom: 1,
    ...
    if (swerp_partner_data){ /* swerp_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < swerp_partner_data.counter; i++) {
            set_marker(swerp_partner_data.partners[i]);
        }
