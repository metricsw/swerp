swerp.define('im_support.SupportMessage', function (require) {
"use strict";
...
var SupportMessage = Message.extend({
    ...
    init: function () {
        ...
        if (this._serverAuthorID !== this.call('mail_service', 'getSwerpbotID')) {
    ...
    getAvatarSource: function () {
        return '/mail/static/src/img/swerp_o.png';
    },
    /**
