...
from swerp import _, api, exceptions, fields, models, tools
from swerp.tools import pycompat, ustr, formataddr
from swerp.tools.misc import clean_context
...
class MailThread(models.AbstractModel):
    ...
    def _notify_specific_email_values(self, message):
        ...
        self.ensure_one()
        return {'headers': repr({
            'X-Swerp-Objects': "%s-%s" % (self._name, self.id),
        })}
   ...
   Only allowed people can contact us at this address.</p>
    ...
    def message_route(self, message, message_dict, model=None, thread_id=None, custom_values=None):
         ...
         * if the message replies to an existing thread by having In-Reply-To or
           References matching swerp model/thread_id Message-Id and if this thread
    ...
    def message_post(self, body='', subject=None,
        ...
        # Post the message
        # canned_response_ids are added by js to be used by other computations (swerpbot)
