...
from swerp import api, release, SUPERUSER_ID
from swerp.exceptions import UserError
from swerp.models import AbstractModel
from swerp.tools.translate import _
from swerp.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Swerp's publisher warranty server to check the
