swerp.define('mail.model.Message', function (require) {
"use strict";
...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    getAvatarSource: function () {
        if (this._isSwerpbotAuthor()) {
            return '/mail/static/src/img/swerpbot.png';
     ...
     *
     * Do not redirect on author clicked of self-posted or Swerpbot messages
     * (note: Swerpbot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isSwerpbotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If Swerpbot is the author (default author for transient messages),
     * returns 'Swerpbot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is SwerpBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isSwerpbotAuthor: function () {
        return this._serverAuthorID === this.call('mail_service', 'getSwerpbotID');
    },
    /**
