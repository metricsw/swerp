...
def safe_eval(expr, globals_dict=None, locals_dict=None, mode="eval", nocopy=False, locals_builtins=False):
    ...
    except swerp.exceptions.except_orm:
        raise
    except swerp.exceptions.Warning:
        raise
    except swerp.exceptions.RedirectWarning:
        raise
    except swerp.exceptions.AccessDenied:
        raise
    except swerp.exceptions.AccessError:
        raise
    except werkzeug.exceptions.HTTPException:
        raise
    except swerp.http.AuthenticationError:
        raise
