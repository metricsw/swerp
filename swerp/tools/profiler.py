...
class _LogTracer(object):
    ...
    def tracer(self, frame, event, arg):
        ...
        if not isinstance(in_self, swerp.models.BaseModel):
            return self.tracer
...
def profile(method=None, whitelist=None, blacklist=(None,), files=None,
    ...
    """
        ...
        all methods for all swerp models by applying the optional filters.
        ...
        :param list blacklist: list model names to remove from the log
                        (Default: remove non swerp model from the log: [None])
        ...
        .. code-block:: python
          ...
          from swerp.tools.profiler import profile
          ...
          class SaleOrder(models.Model):
            ...
            ...
            @api.multi
            @profile()                  # log all methods for all swerp models
            def unlink(self):
            ...
            @profile(whitelist=['sale.order', 'ir.model.data'])
            def action_quotation_send(self):
            ...
            @profile(files=['/home/openerp/swerp/swerp/addons/sale/models/sale.py'])
            def write(self):
            ...
    ...
    def _swerpProfile(method, *args, **kwargs):
    ...
    if not method:
        return lambda method: decorator(_swerpProfile, method)

    wrapper = decorator(_swerpProfile, method)
    return wrapper
