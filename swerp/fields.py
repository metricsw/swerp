...
class Field(MetaField('DummyField', (object,), {})):
    """ The field descriptor contains the field definition, and manages accesses
        ...
        :param str group_operator: aggregate function used by :meth:`~swerp.models.Model.read_group`
        ...
        recordset. The decorator :meth:`swerp.api.depends` must be applied on
        ...
        is extended (see :class:`~swerp.models.Model`), one can also extend
...
class Monetary(Field):
    ...
    def convert_to_cache(self, value, record, validate=True):
        ...
        if validate and record[self.currency_field]:
            # FIXME @rco-swerp: currency may not be already initialized if it is
