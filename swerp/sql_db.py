...
"""
The PostgreSQL connector is a connectivity layer between the Swerp code and
...
def close_db(db_name):
    """ You might want to call swerp.modules.registry.Registry.delete(db_name) along this function."""
    global _Pool
    if _Pool:
